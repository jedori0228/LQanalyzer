...
void trilepton_mumumu_FR_method::ExecuteEvents()throw( LQError ){
  ...
  weight = m_datadriven_bkg->Get_DataDrivenWeight(false, muontriLooseColl, "MUON_HN_TRI_TIGHT", 3, empty_electron, "ELECTRON_HN_TIGHT", 0);
