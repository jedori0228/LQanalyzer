...
void FakeRateCalculator_Mu_dxysig_DILEP::ExecuteEvents()throw( LQError ){
  ...
  std::vector<snu::KJet> jetColl_hn = GetJets("JET_HN_eta5", 20., 2.5);
...
*/
  ...
  std::vector<snu::KMuon> TEST_tight = GetMuons("MUON_HN_TIGHT");
  std::vector<snu::KMuon> TEST_loose = GetMuons("MUON_HN_LOOSE");
