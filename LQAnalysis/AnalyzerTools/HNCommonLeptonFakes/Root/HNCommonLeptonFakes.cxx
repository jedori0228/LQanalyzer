...
float HNCommonLeptonFakes::get_eventweight(bool geterr, std::vector<TLorentzVector> muons, TString muid, std::vector<TLorentzVector> electrons, TString elid, std::vector<bool> isT, int HalfSampleErrorDir){
  ...
  for(unsigned int i=0; i<n_leptons; i++){
    ...
    //==== If not, it's an electron
      ...
      fr.push_back( getFakeRate_electronEta(0, lep_pt.at(i), lep_eta.at(i), "pt_eta_40_ELECTRON16_HN_TIGHT_DXYSIG_dijet_d0_dxysig") );
      pr.push_back( getEfficiency_electron(0, lep_pt.at(i), lep_eta.at(i)) );
      fr_err.push_back( getFakeRate_electronEta(1, lep_pt.at(i), lep_eta.at(i), "pt_eta_40_ELECTRON16_HN_TIGHT_DXYSIG_dijet_d0_dxysig") );
