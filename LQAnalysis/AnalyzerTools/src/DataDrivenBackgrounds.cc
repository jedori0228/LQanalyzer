...
float DataDrivenBackgrounds::Get_DataDrivenWeight(bool geterr, std::vector<snu::KMuon> k_muons, TString muid, int n_muons, std::vector<snu::KElectron> k_electrons, TString elid, int n_electrons, int HalfSampleErrorDir){
  ...
  this_weight =m_fakeobj->get_eventweight(geterr, muons, muid, electrons, elid, isT, HalfSampleErrorDir);
