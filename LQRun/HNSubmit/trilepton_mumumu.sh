...
##### Validation #####
sktree_bkg -a Validation_trilepton -S DoubleMuon -s SKTree_DiLepSkim -n 100
sktree_bkg -a Validation_trilepton -list dilep_CR_bkg -s SKTree_DiLepSkim -n 100
...
sktree_bkg -a trilepton_mumumu_CR -list dilep_CR_bkg -s SKTree_DiLepSkim -n 100 ## dilep
## optional : sktree_bkg -a trilepton_mumumu_CR -list dilep_CR_bkg -s SKTree_DiLepSkim -n 100 -userflag DoKeepFake -o /data2/CAT_SKTreeOutput/JobOutPut/jskim/LQanalyzer/data/output/CAT/trilepton_mumumu_CR/periodBtoG/keepfake/  ## dilep, keep fake
