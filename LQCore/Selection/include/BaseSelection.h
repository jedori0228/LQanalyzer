...
class BaseSelection {
 ...
 public:
  ...
  enum ID {
    ...
    PHOTON_POG_TIGHT               = 38, 
    MUON_HN_TRI_NODXYCUT_TIGHT     = 39,
    MUON_HN_TRI_NODXYCUT_LOOSE     = 40,
    MUON_HN_TRI_TIGHT              = 41,
    MUON_HN_TRI_LOOSE              = 42,
    MUON_HN_TRI_HIGHDXY_TIGHT      = 43,
    MUON_HN_TRI_HIGHDXY_LOOSE      = 44,
  };
